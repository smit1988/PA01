...
const int section_num  =  2;   // section number, 1=Quinn, 2=Lu
...
const float pa09       =  0; // PA09
const float pa10       =  5.0; // PA10
const float pa11       =  0; // PA11
const float pa12       =  0; // PA12

const float ex1        = 15.5; // exam #1, total

const float ex2        = 9.5; // exam #2, total
const float ex2_q1     =  0.5; // exam #2, Q1, struct types
const float ex2_q2_2   =  1.0; // exam #2, Q2.2, integer parition corrections
const float ex2_q3     =  3.0; // exam #2, Q3, sort vector array
const float ex2_q4     =  5.0; // exam #2, Q4, binary files

const float ex3        = 3.0; // exam #3, total
const float ex3_q1     =  0.0; // exam #3, Q1, recursion (Lu)
const float ex3_q2     =  0.0; // exam #3, Q2, recursion (Lu)
const float ex3_q3     =  3.0; // exam #3, Q3, BST (Lu) or file I/O (Quinn)

const float ex4        = 0.0; // exam #4, total
const int   ex4_lo1    =  0;   // exam #4, pass learning objective #1, 1=yes, 0=no
const int   ex4_lo2    =  0;   // exam #4, pass learning objective #2, 1=yes, 0=no
const int   ex4_lo3    =  0;   // exam #4, pass learning objective #3, 1=yes, 0=no
const int   ex4_lo4    =  0;   // exam #4, pass learning objective #4, 1=yes, 0=no
...
const float bonus_asgs = 0.0; // bonus for extensions to PA10, total
//////////////////////////////////////////////////////////////////////
